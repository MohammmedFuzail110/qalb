      ...
      <div class="row">
         <div class="col-xxl-12 col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
            <div class="breadcrumb-text text-center">
               <h1>Contact</h1>
               <p><a href="index-2.php">Home</a> / Contact</p>
            </div>
         </div>
      </div>
   </div>
...
<div class="contact-area">
	<div class="container">
		<div class="row align-items-center">
            ...
            <form id="contact-form" action="https://themeforest.wprealizer.com/agencico-preview/agencico/mail.php" method="POST" class="contact-input">
